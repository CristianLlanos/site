...
| Uber link | `https://m.uber.com/ul/?action=setPickup&pickup=my_location&dropoff[latitude]=-12.0892749&dropoff[longitude]=-77.0151988&dropoff[nickname]=Av.%20Javier%20Prado%20Este%201179&dropoff[formatted_address]=Av.%20Javier%20Prado%20Este%201179%2C%20La%20Victoria` (universal link: opens the app when installed, Uber web otherwise — used on the web AND in the email) |
| Box / mesa alta | Box **S/ 50**, mesa alta **S/ 30** — reserved via WhatsApp (floor map on the page) |
